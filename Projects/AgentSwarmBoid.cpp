...
#pragma omp parallel for
  for (int k0= 0; k0 < NbAgents; k0++) {
    ...
    int countEat= 0;
    int countRun= 0;
    Math::Vec3f sep, ali, coh, eat, run, ori;
    ...
    Math::Vec3f center(0.5f, 0.5f, 0.5f);
    ori= center - Pos[k0];
...
void AgentSwarmBoid::Draw() {
  ...
  if (D.displayMode1) {
    for (int k= 0; k < NbAgents; k++) {
      ...
      Math::Vec3f p1= Pos[k] + 0.05f * 2.0f * (+0.5f * front + 0.00f * left + 0.0f * up);
      Math::Vec3f p2= Pos[k] + 0.05f * 2.0f * (+0.0f * front - 0.07f * left + 0.1f * up);
      Math::Vec3f p3= Pos[k] + 0.05f * 2.0f * (+0.0f * front + 0.07f * left + 0.1f * up);
      Math::Vec3f p4= Pos[k] + 0.05f * 2.0f * (+0.0f * front + 0.00f * left - 0.1f * up);
      Math::Vec3f p5= Pos[k] + 0.05f * 2.0f * (-0.4f * front + 0.00f * left + 0.0f * up);
      Math::Vec3f p6= Pos[k] + 0.05f * 2.0f * (-0.6f * front + 0.00f * left - 0.2f * up);
      Math::Vec3f p7= Pos[k] + 0.05f * 2.0f * (-0.6f * front + 0.00f * left + 0.2f * up);
